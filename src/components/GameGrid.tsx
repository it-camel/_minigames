...
import { Gamepad2, Grid3X3, Zap, Brain, Box, Target, Bird, Hash } from 'lucide-react';

type GameGridProps = {
  onGameSelect: (game: 'snake' | '2048' | 'tictactoe' | 'memory' | 'tetris' | 'breakout' | 'flappybird' | 'sudoku') => void;
};
